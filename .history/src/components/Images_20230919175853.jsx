...
const Images = () => {
  ...
  return (
    <div className="w-full">
        <h1>WHEN UPLOADING A PHOTO DON'T USE AN EXISTING NAME IT WILL OVERRIDE YOUR EXISTING PHOTO</h1>
      <Card>
        <div className="">
          ...
          {images &&
            images.map((image) => (
              <figure>
                <img
                  src={image.url}
                  className="max-w-[500px] max-h-[500px] m-5"
                />
                <figcaption className="text-center">{image.imageUrl}</figcaption>
              </figure>
            ))}
        </div>
      </Card>
