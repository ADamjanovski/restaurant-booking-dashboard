              ...
              reservations.map((reservation) => {
                ...
                return (
                  <tr key={reservation.id}>
                    ...
                    {reservation.status ==="CONFIRMED" ?<td className="text-center text-sm">
                      {reservation.status}
                    </td> : reservation.status==="DECLINED"?<td className="text-center text-sm">
                      {reservation.status}
                    </td> : <td className="text-center text-sm">
                      {reservation.status}
                    </td>}
                  </tr>
                );
