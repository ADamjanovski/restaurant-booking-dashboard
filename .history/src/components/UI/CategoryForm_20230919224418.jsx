...
const CategoryForm = ({ onClose, setCategories, initial }) => {
  ...
  const submitHandler = async (event) => {
    ...
    const newCategory = await useHttp({
      url: `http://localhost:3000/api/dashboard/categories/${
    ...
    console.log(innewCategoryitial)
    const newCategories = [...initial];
