    ...
    <div className="w-full h-full">
      <Card className="text-start ">
        ...
        <form className="mt-3 flex flex-col">
          <input
            type="password"
            className="mb-4  rounded-md px-3 py-1 lg:w-3/4"
            placeholder="New Password"
          />
          <input
            type="password"
            className="px-3 py-1 rounded-md mb-4 lg:w-3/4 "
            placeholder="Confirm Password"
          />
          <button className="bg-accent w-1/2 self-center lg:self-start rounded-lg text-black mb-2">Change Password</button>
        </form>
      </Card>
    </div>
  );
