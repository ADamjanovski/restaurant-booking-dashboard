...
const UpcomingReservations = () => {
  ...
  const request = {
    url: `https://restaurant-booking-backend-damjanovski-phi.vercel.app/api/dashboard/upcomingReservations/${authCtx.user.restaurantId}`,
    method: "GET",
    headers: {
              ...
              reservations.map((reservation) => {
                ...
                return (
                  <tr key={reservation.id} className="pt-4">
                    ...
                    <td className="text-center mt-4">{reservation.table.tableNumber}</td>
