                ...
                return (
                  <tr key={reservation.id} className="pt-4">
                    ...
                    {reservation.status === "CONFIRMED" ? (
                      ...
                      <td className="text-center text-sm flex justify-around ">
                        <button className="rounded-lg border bg-red p-2 b">ACCEPT </button>
                        <button className="rounded-lg border bg-red p-2 b">DECLINE</button>
                      </td>
                    )}
                  </tr>
                );
