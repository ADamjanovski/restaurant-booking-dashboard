                  ...
                  <tr key={reservation.id} className="pt-4">
                    ...
                    {reservation.status === "CONFIRMED" ? (
                      ...
                      <td className="text-center text-sm flex justify-around mt-4">
                        <button className="rounded-lg border bg-green-500 p-2 b" value="CONFIRMED">ACCEPT </button>
                        <button className="rounded-lg border bg-red-500 p-2 b" value="DECLINE">DECLINE</button>
                      </td>
                    )}
                  </tr>
                );
