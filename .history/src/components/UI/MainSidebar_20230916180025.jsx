    ...
    <>
      ...
      >
        <div className="flex flex-col w-full mt-20 text-xl p-3 ">
          <NavLink className="mb-3 text-accent" to="restaurantInformation">Restaurant Information</NavLink>
          <NavLink className="mb-3 text-accent" to="upcomingReservations">Upcoming Reservations</NavLink>
