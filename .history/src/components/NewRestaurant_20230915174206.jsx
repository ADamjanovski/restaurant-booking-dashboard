  ...
  return (
    <div className="">
      <form className="flex flex-col my-4" onSubmit={formSubmitHandler}>
        ...
        <input type="text" id="username" className="mx-3 my-1" value={usernameInputValue} />
        ...
        <button className="border-1 bg-accent my-4 w-1/3 self-center rounded-lg">Add Restaurant</button>
      </form>
    </div>
  );
};
