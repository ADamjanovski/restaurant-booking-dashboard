    ...
    <>
      ...
      >
        <div className="flex flex-col w-full mt-20 text-xl p-3 ">
          <NavLink className="mb-3 text-accent" to="personalInformation">Restaurant Information</NavLink>
          <NavLink className=" mb-3text-accent" to="restaurants">Upcoming Reservations</NavLink>
          <NavLink className= >Past Reservations</NavLink>
        </div>
      </div>
    </>
  );
