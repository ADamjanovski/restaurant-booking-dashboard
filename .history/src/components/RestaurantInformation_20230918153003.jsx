...
const RestaurantInformation = () => {
  ...
  return (
    <div className="w-full h-full ">
      <Card className="text-start flex ">
        ...
        {(authCtx.user.categories===undefined || authCtx.usercategories.length === 0) && (
          <p className="text-center">No Categories chosen for your restaurant choose some!!!</p>
        )}
        <button className="self-center">Add a category</button>
      </Card>
    </div>
  );
};
